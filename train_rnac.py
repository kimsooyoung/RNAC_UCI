...
def main(args, number):
    ...
    # we need to rebuild an environment
    env_evaluate = gym.make(args.env)  
    # When sampling multiple next states, 
    # we need to return to the current states
    ...
    while total_steps < args.max_train_steps:
        ...
        # s_org, x_pos = copy.deepcopy(s), np.array([env.unwrapped.data.qpos])
